/**
  *  =====================================================================
  *  ChillerModel.java: Construct a simple 2D model for a House.
  *
...
public class ChillerModel extends AbstractCompoundFeature {

   public ChillerModel( double x, double y, double width) {

      // Create label for the house model ...

      setName( "Chiller Model" );
      ...
      Point node03 = new Point(      "top01",    x + width,     y + width, pSize, pSize );
      Point node04 = new Point(      "top02",            x,     y + width, pSize, pSize );
