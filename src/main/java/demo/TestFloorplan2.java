...
public class TestFloorplan2 {
	...
	public static void main(String args[]) throws ParseException{
		...
		box2.setCoordinatePair( 40, 10, 50, 20 );
		...
		box5.setCoordinatePair( 39, 9, 41, 21 );
		floorplanModel.addWallCorner( box5 );
		
		CoordinatePair box6 = new CoordinatePair();
		box6.setCoordinatePair( 49, 9, 51, 21 );
		floorplanModel.addWallCorner( box6 );
		
		CoordinatePair box7 = new CoordinatePair();
		box7.setCoordinatePair( 8, 8, 52, 22 );
		floorplanModel.addExteriorWall( box7 );
		...
		System.out.println("*** ");
		System.out.println("*** =========================================================== ");
		System.out.println("*** III : Move center line ( 0, 2 ) ...");
	    System.out.println("*** =========================================================== ");
		System.out.println("*** ");
